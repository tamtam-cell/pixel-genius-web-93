...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[60rem] md:h-[80rem] flex items-center justify-center relative p-0 md:p-2 -mt-32"
      ref={containerRef}
    >
      <div
...
const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-[98%] -mt-8 mx-auto h-[45rem] md:h-[55rem] w-full border-4 border-[#6C6C6C] p-0.5 md:p-2 bg-[#222222] rounded-[30px] shadow-2xl"
    >
